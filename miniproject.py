...
def register():
    ...
    username = StringVar()
    password = StringVar()
    label_0 = Label(register_screen, text="Registration Form",width=35,font=("bold", 25),fg='light sea green',justify='center')
    label_0.place(x=150,y=53)

    name = StringVar()
    phone = IntVar()
    registrationid = IntVar()
    Label(register_screen, text="Please enter the below details",fg="teal",font=( 'ms sans serif' ,25, 'bold' )).place(x=200,y=0)

    label_1 = Label(register_screen, text="Full Name",width=20,font=("bold", 15))
    label_1.place(x=240,y=130)

    entry_1 = Entry(register_screen,textvariable=name)
    entry_1.place(x=440,y=130)

    label_2 = Label(register_screen, text="Phone number",width=20,font=("bold", 15))
    label_2.place(x=250,y=180)

    entry_2 = Entry(register_screen,textvariable=phone)
    entry_2.place(x=440,y=180)
    
    label_3 = Label(register_screen, text="Registration Id",width=20,font=("bold", 15))
    label_3.place(x=250,y=230)

    entry_3 = Entry(register_screen,textvariable=registrationid)
    entry_3.place(x=440,y=230)

    label_4 = Label(register_screen, text="Gender",width=20,font=("bold", 15))
    label_4.place(x=250,y=280)
    var = IntVar()
    Radiobutton(register_screen, text="Male",font=('vani', 13),variable=var, value=1).place(x=440,y=280)
    Radiobutton(register_screen, text="Female",font=('vani', 13), variable=var, value=2).place(x=550,y=280)
    label_5 = Label(register_screen, text="Email",width=20,font=("bold", 15))
    label_5.place(x=250,y=330)
    email=StringVar()
    entry_5 = Entry(register_screen,textvariable=email,width=40)
    entry_5.place(x=440,y=330)

    username_lable = Label(register_screen, text="Username",font=( 'Times New Roman' ,20, 'italic' ),)
    username_lable.place(x=300,y=380)
    username_entry = Entry(register_screen, font=( 15 ),bd=2,textvariable=username)
    username_entry.place(x=440,y=380)
    password_lable = Label(register_screen, text="Password",font=( 'Times New Roman' ,20, 'italic' ))
    password_lable.place(x=300,y=420)
    ...
    Button(register_screen, text="Register", width=13, height=2, bg='red2',fg='white', command = register_user).place(x=480,y=500)
...
def login():
    ...
    Label(login_screen, text="Please enter your details below to login",fg='steel blue',font=( 'kalinga' ,17, 'bold' )).place(x=170,y=0)
    ...
    Label(login_screen,font=( 'lau ui' ,17,'italic' ), text="Username").place(x=250,y=50)
    username_login_entry = Entry(login_screen,font=(17) ,textvariable=username_verify)
    username_login_entry.place(x=250,y=100)
    Label(login_screen,font=( 'lau ui' ,17, 'italic' ), text="Password").place(x=250,y=150)
    password_login_entry = Entry(login_screen,font=(17 ), textvariable=password_verify, show= '*')
    password_login_entry.place(x=250,y=200)
    Button(login_screen, text="Login", width=10, height=1,bg='red3',fg='white', command = login_verify).place(x=275,y=250)
...
def BMR():
    ...
    in_screen.geometry("950x780")

    l1 = Label(in_screen, text='Weight(in kg)',font=3)
    l2 = Label(in_screen, text='Height(in cms)',font=3)
    l3 = Label(in_screen, text='Age',font=3)
    l4 = Label(in_screen, text = 'Gender', bg = 'white',font=2)
    l5 = Label(in_screen, text = 'Activity', bg = 'white',font=2)
    ...
    Lb = Listbox(in_screen,bg="peach puff",fg="black", height=7, width=30,font=2)
    ...
    Lb2 = Listbox(in_screen, height=2, width=20,font=1)
    Lb2.insert(1, 'Male')
    Lb2.insert(2, 'Female')
    ...
    b1 = Button(in_screen, text = 'Submit',font=2,bg="red4",fg='white',height=2, width=20, command = CALO).place(x=220,y=350)
...
def CALO():
    ...
    if cal<1500:
        fin = StringVar()
        l6 = Label(in_screen,bg="light pink2",fg="black",font=0.6, textvariable=fin, relief=RAISED )
        fin.set("Breakfast: "+protein[randint(0, 4)]+" + "+fruit[randint(0, 5)])
        l6.grid(row=0,column=3)


        fin2 = StringVar()
        l8 = Label(in_screen,bg="light pink2",fg="black",font=0.6, textvariable=fin2, relief=RAISED )
        ...
        fin3 = StringVar()
        l9 = Label(in_screen,bg="light pink2",fg="black",font=0.6, textvariable=fin3, relief=RAISED )
        fin3.set("Snack: "+ps[randint(0, 4)]+" + "+vegetable[0])
        l9.grid(row=2,column=3)


        fin4 = StringVar()
        l10 = Label(in_screen,bg="light pink2",fg="black",font=0.6, textvariable=fin4, relief=RAISED )
        ...
        fin5 = StringVar()
        l11 = Label(in_screen,bg="light pink2",fg="black",font=0.6,textvariable=fin5, relief=RAISED )
...
def main_account_screen():
    ...
    lblinfo = Label(font=( 'Times New Roman' ,45, 'bold' ),text="AI DIETICIAN",fg="purple3",bd=10)
    lblinfo.place(x=435,y=15)
    lb1 = Label(font=( 'Times New Roman' ,20 ),text="Already a user ??",fg="royal blue2",bd=10)
    lb1.place(x=550,y=190)
    lb2 = Label(font=( 'Times New Roman' ,20 ),text="A New User ??",fg="royal blue2",bd=10)
    lb2.place(x=550,y=300)
    b=Button(text="Login", height="3", width="35", command = login, bg="orange red2",)
    b.place(x=520,y=240)
    c=Button(text="Register", height="3", width="35", command=register, bg="orange red2")
    c.place(x=520,y=340)
